...
#[Fillable(['partner_id', 'conference_id', 'title', 'description', 'format', 'organizers', 'co_hosts', 'target_audience', 'expected_participants', 'is_open', 'special_requirements', 'session_lead_id', 'communications_lead_id', 'session_slot_id', 'status', 'submitted_at'])]
